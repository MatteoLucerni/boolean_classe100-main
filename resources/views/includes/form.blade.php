...
<div class="row">
    <div class="col-4">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="fname" name="first_name" value="{{ old('fist_name') }}"
                autofocus>
            @error('first_name')
...
<div class="row">
    ...
    <div class="col-2">
        ...
        <input type="number" class="form-control" id="postal-code" name="post_code" value="{{ old('post_code') }}">
    </div>
</div>
